...
void System_Init()
{
	task_structs[OLED_Display_TASK].enable_flag=1;
	task_structs[OLED_Display_TASK].interval_time=200;
	task_structs[OLED_Display_TASK].f=task1;
	
	task_structs[B30Read_TASK].enable_flag=1;
	task_structs[B30Read_TASK].interval_time=400;
	task_structs[B30Read_TASK].f=task2;
	
	task_structs[SendMsg_TASK].enable_flag=1;
	task_structs[SendMsg_TASK].interval_time=100;
	task_structs[SendMsg_TASK].f=task3;
}
